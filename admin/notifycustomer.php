...
<?php include_once('includes/header_end.php'); ?>
                            ...
                            <ul class="list-inline menu-left mb-0">
                                ...
                                <li class="hide-phone list-inline-item app-search">
                                    <h3 class="page-title">Notify Customer</h3>
                                </li>
                            </ul>
                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card m-b-20">
                                        <div class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Notify Customer</h4>
                                            <br>
            
                                            <form class="" action="" method="POST">
                                                <div class="form-group">
                                                    <label>Select Customer</label>
                                                    <select class="form-control" name="customerid" autofocus>
                                                        ...
                                                        <?php  
                                                                ...
                                                                if(mysqli_num_rows($query)){
                                                                    while($row=mysqli_fetch_array($query)){
                                                                        ?>
                                                                        <option value="<?php echo $row['customer_id']; ?>"><?php echo $row['customer_name'].','.$row['customer_city']; ?></option>
                                                                        <?php
                                                                    }
                                                                }
                                                        ?>
                                ...
                                $sql="INSERT INTO notify (admin,email,subject,message,notify_to) VALUES ('$admin','$email','$subject','$message',$customerid)";
                    ...
                    <script>
                        Swal.fire(
                        {
                            ...
                            window.location='Notifycustomer.php';
                        });
                    </script>
                    <?php      
                                    }
