                                                                ...
                                                                if(mysqli_num_rows($query)){
                                                                    while($row=mysqli_fetch_array($query)){
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><a href="update_booking.php?booking_id=<?php echo $row['booking_id']; ?>" class="btn btn-success">Update</a><a href="delete_function.php?booking_id=<?php echo $row['route_id']; ?>" class="btn btn-danger">Delete</a></td>
