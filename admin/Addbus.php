                    ...
                    <div class="page-content-wrapper">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                          ...
                                          <br>
                                            ...
                                            <form class="" action="" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="routeid" autofocus>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" required placeholder="Enter Chasis Number"name="chasisno" data-parsley-pattern="/^([A-Za-z]{2}[A-z0-9]{5,16})$/" title="Enter Valid Chasis Number">
                                                </div>
                                ...
                                $image_loc='';
                                $bus_img='default.jpg';
                                $target_folder='assets/images/bus/'; 
