                                                                ...
                                                                if(mysqli_num_rows($query)){
                                                                    while($row=mysqli_fetch_array($query)){
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            ?></td>
                                                                            <td><a href="update_bus.php?bus_id=<?php echo $row['bus_id']; ?>" class="btn btn-success">Update</a><a href="delete_function.php?bus_id=<?php echo $row['bus_id']; ?>" class="btn btn-danger">Delete</a></td>
                                                                        </tr>
